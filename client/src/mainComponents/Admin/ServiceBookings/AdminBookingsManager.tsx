...
import {
  BarChart3, Calendar, Clock, Search,
...
const AdminBookingsManager: React.FC = () => {
  ...
  const { data: bookingsData, isLoading: bookingsLoading, error: bookingsError, refetch: refetchBookings } =
    ...
    return (
      <Card className="border-red-200">
        <CardContent className="p-6 text-center">
          ...
          <Button variant="outline" onClick={() => { refetchBookings(); refetchStats(); }} className="mt-2">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                        ...
                        {getStatusOptions(booking.status).length > 0 && (
                          <select
                            ...
                            onChange={(e) => {
                              if (e.target.value) handleStatusUpdate(booking._id, e.target.value);
                            }}
                          >
              ...
              {bookingsData && bookingsData.totalPages > 1 && (
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6">
                  <p className="text-sm text-muted-foreground">
                    ...
                    {Math.min(filters.page * filters.limit, bookingsData.total)} of {bookingsData.total} bookings
                  </p>
