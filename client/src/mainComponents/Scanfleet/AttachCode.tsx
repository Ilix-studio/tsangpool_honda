...
export default function AttachCode() {
      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          ...
          <p className="text-yellow-700 mb-4">
            Please complete your profile before activating ScanFleet safety package.
          </p>
          <Link
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6">Activate ScanFleet Safety Package</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, attachCode: e.target.value.toUpperCase() })
            }
            required
